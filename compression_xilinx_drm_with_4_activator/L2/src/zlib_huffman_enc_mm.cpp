...
void huffman(hls::stream<encodedV_dt> in[PARALLEL_BLOCK],
             ...
             hls::stream<uint32_t> str_litmtree_codes[PARALLEL_BLOCK],
             hls::stream<uint32_t> str_distree_codes[PARALLEL_BLOCK],
             hls::stream<uint32_t> str_bitlentree_codes[PARALLEL_BLOCK],
             hls::stream<uint32_t> str_litmtree_blen[PARALLEL_BLOCK],
             hls::stream<uint32_t> str_dtree_blen[PARALLEL_BLOCK],
             hls::stream<uint32_t> str_bitlentree_blen[PARALLEL_BLOCK],
             hls::stream<uint32_t> str_max_codes[PARALLEL_BLOCK],
             uint32_t n_blocks) {
...
#pragma HLS dataflow
    ...
    #pragma HLS unroll
        huffmanCore(in[i], outStream512[i], outStream512Eos[i], input_size[i], str_litmtree_codes[i],
                    str_litmtree_blen[i], str_distree_codes[i], str_dtree_blen[i], str_bitlentree_codes[i],
                    str_bitlentree_blen[i], str_max_codes[i], compressedSize[i]);
    }
...
void xilHuffmanKernel(//uint32_t wr_block_idx,
                      ...
                      hls::stream<uint32_t> dyn_litmtree_codes[PARALLEL_BLOCK],  
                      hls::stream<uint32_t> dyn_distree_codes[PARALLEL_BLOCK],   
                      hls::stream<uint32_t> dyn_bitlentree_codes[PARALLEL_BLOCK],
                      hls::stream<uint32_t> dyn_litmtree_blen[PARALLEL_BLOCK],   
                      hls::stream<uint32_t> dyn_dtree_blen[PARALLEL_BLOCK],      
                      hls::stream<uint32_t> dyn_bitlentree_blen[PARALLEL_BLOCK], 
                      hls::stream<uint32_t> dyn_max_codes[PARALLEL_BLOCK],       
