...
//typedef ap_fixed<48, 24> intm_t;
//typedef ap_fixed<20, 17> data_t;
//typedef ap_fixed<25, 2> wght_t;
//typedef ap_fixed<32, 17> if_data_t;
//typedef ap_fixed<32, 2> if_wght_t;

//typedef ap_fixed<20, 17> intm_t;
//typedef ap_fixed<20, 17> data_t;
//typedef ap_fixed<25, 2> wght_t;
//typedef ap_fixed<32, 17> if_data_t;
//typedef ap_fixed<32, 2> if_wght_t;
...
typedef ap_fixed<20, 16> data_t;
typedef ap_fixed<25, 2> wght_t;
typedef ap_fixed<32, 16> if_data_t;
typedef ap_fixed<32, 2> if_wght_t;

//typedef ap_fixed<48, 24> intm_t;
//typedef ap_fixed<18, 17> data_t;
//typedef ap_fixed<25, 2> wght_t;
//typedef ap_fixed<32, 17> if_data_t;
//typedef ap_fixed<32, 2> if_wght_t;


//typedef ap_fixed<16, 5> intm_t;
//typedef ap_fixed<16, 5> data_t;
//typedef ap_fixed<16, 2> wght_t;
